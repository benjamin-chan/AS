...
*/
%inc "W:\Arthritis Studies\UCB_AS\SAScodeFromBen\lib\libname.sas";
%inc "W:\Arthritis Studies\UCB_AS\SAScodeFromBen\lib\expo.sas";
...
data &indat.2;
set _tmptwodx(keep=patid cohort_date  &datevar. &datevar.2nd dx1todx2 dx2eligible);
...
as select a.*, b.birth_date, b.death_date, int((A.indexdate - B.birth_date) / 365.25), 
