...
proc sql;
  ...
  create table cohortASTDSABR as
    select distinct
           A.patid,
...
/*AS dx 720.x */
data uab_dx_720;
set std_sabr.std_dx_2006   
    std_sabr.std_dx_2007   
std_sabr.std_dx_2007   
    std_sabr.std_dx_2007   
    std_sabr.std_dx_2008_v2
    std_sabr.std_dx_2009   
std_sabr.std_dx_2009   
    std_sabr.std_dx_2009   
    std_sabr.std_dx_2010   
std_sabr.std_dx_2010   
    std_sabr.std_dx_2010   
    std_sabr.std_dx_2011   
std_sabr.std_dx_2011   
    std_sabr.std_dx_2011   
    std_sabr.std_dx_2012   
std_sabr.std_dx_2012   
    std_sabr.std_dx_2012   
    std_sabr.std_dx_2013   
std_sabr.std_dx_2013   
    std_sabr.std_dx_2013   
    std_sabr.std_dx_2014   ;
...
select count(distinct patid) from DT.cohortASTD_SABR;
select count(distinct patid) from cohortASTDSABR;
...
select * from cohort2
where patid not in (select distinct patid from DT.cohortASTD_SABR);

select * from DT.cohortASTD_SABR
...
set STD_SABR.STD_RX_2006 
    STD_SABR.STD_RX_2007 
    STD_SABR.STD_RX_2008 
    STD_SABR.STD_RX_2009 
    STD_SABR.STD_RX_2010 
    STD_SABR.STD_RX_2011 
    STD_SABR.STD_RX_2012 
    STD_SABR.STD_RX_2013 
    STD_SABR.STD_RX_2014 ;
...
set STD_SABR.STD_PX_2006
    STD_SABR.STD_PX_2007
    STD_SABR.STD_PX_2008
    STD_SABR.STD_PX_2009
    STD_SABR.STD_PX_2010
    STD_SABR.STD_PX_2011
    STD_SABR.STD_PX_2012
    STD_SABR.STD_PX_2013
    STD_SABR.STD_PX_2014;
format FACILITY_TYPE;
rc=hNDC.find(key:px);
if rc=0;
run;
...
proc sort data=BioSABRstd nodupkey; by patid gnn DISPENSE_DATE;run;
...
proc sql;
  create table indexLookup AS
    select "Medicare" as database, "TNF"   as exposure, &var from ASTNFCohortSABRStd_ex1     union corr
    select "Medicare" as database, "DMARD" as exposure, &var from ASDMARDCohortSABRStd_ex2   union corr
    select "Medicare" as database, "NSAID" as exposure, &var from ASNSAIDCohortSABRStd_ex2   union corr
    select "Medicare" as database, "No exposure" as exposure, &var from ASNoExpCohortSABRStd_ex2  ;
...
left join ASTNFCohortSABRStd_ex1 b
