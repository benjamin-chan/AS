...
* Modify date   :
;
%let cmt=buildServiceCodeDatasetsControl; * type the name of your program here (without the filename extension);
%let pgm=&cmt..sas;
...
%include "lib\buildPxControl.sas";  /* Call script to query procedure codes */
