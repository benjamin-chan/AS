...
Compare **TNF** versus **NSAID or no exposure**.

```{r}
compareIncidenceRates("MPCD", c("TNF", "NSAID or no exposure"), "Cardiac disease", "Aortic Insufficiency/Aortic Regurgitation")
```
