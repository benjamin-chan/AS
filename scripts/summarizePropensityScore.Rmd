...
```{r, fig.show = "hide", warning = FALSE, message = FALSE}
f <- "covarBalAVRheumEncounters"
L <- covariateBalance("dichotomous", "indAVRheumEncounters", "% Outpatient rheumatologist encounter in 12 months prior")
ggsave(paste0("../figures/", f, ".png"), dpi = 300)
ggsave(paste0("../figures/", f, ".svg"), dpi = 300)
```
...
```{r, fig.show = "hide", warning = FALSE, message = FALSE}
f <- "covarBalBiologics12mPrior"
L <- covariateBalance("dichotomous", "indBiologics12mPrior", "% Biologics Rx in 12 months prior")
ggsave(paste0("../figures/", f, ".png"), dpi = 300)
ggsave(paste0("../figures/", f, ".svg"), dpi = 300)
```
